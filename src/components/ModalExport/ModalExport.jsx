...
import ButtonCompleteSVG from '../../assets/images/buttonComplete.svg?react'
import ButtonCountourSVG from '../../assets/images/buttonContour.svg?react'
...
const Modal = forwardRef((props,ref) => {
    ...
    const share = (type) => {
      ...
      try {
        ...
        try {
          ...
          saleforceApiUtils.storeLog(import.meta.env,infoLog)
    ...
    const insertExport = async (data) => {
      dbInteractions.createRecordNonEditable('exports', import.meta.env.VITE_JWT_TOKEN, data.body).then(res => {
    ...
    const updateVisitModal = async (body) => {
      dbInteractions.updateRecordNonEditable('visits', import.meta.env.VITE_JWT_TOKEN, visitId, body)
    }
